...
begin
  ...
  begin
    Result := ((FHeader.StreamMarker[1] = Ord('f')) AND (FHeader.StreamMarker[2] = Ord('L')) AND (FHeader.StreamMarker[3] = Ord('a')) AND (FHeader.StreamMarker[4] = Ord('C'))) AND (FChannels > 0) AND (FSampleRate > 0) AND
      (FBitsPerSample > 0) AND (FSamples > 0);
  end;
  ...
  try
    ...
    begin
      ...
      begin
        ...
        if (FOggFlacHeader.PacketType = $7F) AND ((FOggFlacHeader.Signature[1] = Ord('F')) AND (FOggFlacHeader.Signature[2] = Ord('L')) AND (FOggFlacHeader.Signature[3] = Ord('A')) AND (FOggFlacHeader.Signature[4] = Ord('C'))) AND
          (FOggFlacHeader.MajorVersion = 1) AND ((FOggFlacHeader.StreamInfo.StreamMarker[1] = Ord('f')) AND (FOggFlacHeader.StreamInfo.StreamMarker[2] = Ord('L')) AND (FOggFlacHeader.StreamInfo.StreamMarker[3] = Ord('a')) AND

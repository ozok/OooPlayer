      ...
      case SearchType of
        ...
        stradio:
          begin
            ...
            begin
              Application.ProcessMessages;
              if ContainsText(MainForm.FRadioStations[i].Name.ToUpperInvariant(), LQuery.ToUpperInvariant()) or ContainsText(MainForm.FRadioStations[i].URL, LQuery.ToUpperInvariant()) then
              begin
                FResultsList.Add(i);
